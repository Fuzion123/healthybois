        ...
        <div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <div className="flex flex-col mt-2 mb-4 shadow-md rounded-lg px-3 pt-2 pb-3">
                    ...
                    <p className="text-base py-2"><span className="font-bold">Name:</span><br></br> {user.firstName} {user.lastName}</p>
                    <p className="text-base py-2"><span className="font-bold">Email:</span><br></br> {user.email}</p>
                    <p className="text-base py-2"><span className="font-bold">User Name:</span><br></br> {user.username}</p>
                    <p className="text-base py-2"><span className="font-bold">Profile Picture</span><br></br><img className="mt-1 h-20 w-20 rounded-full" src={user.profilePictureUrl} alt="Profile pic"/></p>
                </div>
                <div className="flex flex-col mt-2 mb-4 shadow-md rounded-lg px-3 pt-2 pb-3">
                    ...
                    <div className="grid grid-cols-1 gap-y-2 md:grid-cols-2 md:gap-x-10 lg:grid-cols-3">
                        {data?.map(event =>
                        <div key={event.id} className="flex flex-col my-8 shadow-md rounded-lg">
                                <div className="">
