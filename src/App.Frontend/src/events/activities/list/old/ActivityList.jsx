...
export default function ActivityList(props) {
  ...
  function calculateBubblePosition(index, totalBubbles, containerSize) {
    ...
    const x =
      Math.cos(angle) * adjustedRadius * (containerSize > 390 ? 1 : 0.8);
    const y =
      Math.sin(angle) * adjustedRadius * (containerSize < 390 ? 1 : 0.6);
  ...
  return (
    <div>
      <h3 className="text font-bold mb-2">Activities</h3>
      <div className="relative mt-72">
        {props.activities.map((p, index) => {
          ...
          const baseBubbleSize = isMobile ? 50 : 120;
